...
#define _DF_PDR0_DEFAULT        (0xDFU) /* PDR0 default value */
#define _FF_PDR0_DEFAULT        (0xFFU) /* PDR0 default value */
#define _33_PDR1_DEFAULT        (0x33U) /* PDR1 default value */
#define _3F_PDR2_DEFAULT        (0x3FU) /* PDR2 default value */
#define _0C_PDR3_DEFAULT        (0x0CU) /* PDR3 default value */
#define _F0_PDR4_DEFAULT        (0xF0U) /* PDR4 default value */
#define _F7_PDR5_DEFAULT        (0xF7U) /* PDR5 default value */
...
#define _29_PDRA_DEFAULT        (0x29U) /* PDRA default value */
#define _1F_PDRB_DEFAULT        (0x1FU) /* PDRB default value */
#define _0C_PDRC_DEFAULT        (0x0CU) /* PDRC default value */
#define _03_PDRD_DEFAULT        (0x03U) /* PDRD default value */
#define _38_PDRE_DEFAULT        (0x38U) /* PDRE default value */
#define _FF_PDRF_DEFAULT        (0xFFU) /* PDRF default value */
#define _FF_PDRG_DEFAULT        (0xFFU) /* PDRG default value */
#define _FF_PDRJ_DEFAULT        (0xFFU) /* PDRJ default value */
